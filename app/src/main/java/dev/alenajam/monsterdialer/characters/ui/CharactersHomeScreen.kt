...
fun CharactersHomeScreen(
    ...
    Column(
        ...
        CharacterHomeItem(R.string.import_character, R.string.import_character_description, LocalMonsterAppIcons.current.importPacks, RoundedCornerShape(2.dp)) { picker.launch(arrayOf("*/*")) }
